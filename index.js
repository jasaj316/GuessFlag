...
function answer(type = "answer") {
  if (type === "answer") {
    ...
    scoretext.innerHTML = `Score: ${Math.abs(Math.round(360 - (Math.abs(guessMarker._latlng.lat - marker._latlng.lat) + Math.abs(guessMarker._latlng.lng - marker._latlng.lng))))}`;
  } else if (type === "r") {
